...
  const navigate = useNavigate(); // <-- NEW: Initialize the navigation function
...
          {/* MODIFIED: Added onClick handler to navigate to a specific alert detail page */}
          <button 
...
        </div>
      ))}
      {/* MODIFIED: Added onClick handler to navigate to the full alerts list */}
      <button 
